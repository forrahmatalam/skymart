    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-gray-500">Join SkyMart to start shopping</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2.5 pr-10 text-sm outline-none transition focus:ring-2 ${
                  errors.password ? "border-red-300 focus:ring-red-100" : "border-gray-300 focus:border-brand-500 focus:ring-brand-100"
                }`}
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className={`w-full rounded-lg border px-3 py-2.5 text-sm outline-none transition focus:ring-2 ${
                errors.confirmPassword ? "border-red-300 focus:ring-red-100" : "border-gray-300 focus:border-brand-500 focus:ring-brand-100"
              }`}
